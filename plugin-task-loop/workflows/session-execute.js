...
//
//   // --- Per-role budgets (advisory; omit to use defaults) ---
//   budgets?: {
//     developer?: { max_turns?: number, max_tool_calls?: number, soft_wall_time_s?: number },
//     'integration-tester'?: { max_turns?: number, max_tool_calls?: number, soft_wall_time_s?: number },
//     reviewer?: { max_turns?: number, max_tool_calls?: number, soft_wall_time_s?: number },
//   },
//
...
// ============================================================
// Per-role turn/tool budgets (advisory)
// ============================================================
// --- BEGIN GENERATED: budget (source: lib/budget.js) ---
// AUTO-GENERATED — DO NOT EDIT BY HAND.
// Source: plugin-task-loop/workflows/lib/budget.js
// Regenerate: ./scripts/sync-workflow-inline.sh
...
// --- END GENERATED: budget ---

const RESOLVED_BUDGETS = budgets !== undefined ? resolveBudgets(budgets) : null;

// ============================================================
// Gate ledger — per-round stage verdict history
// ============================================================
// --- BEGIN GENERATED: gate-ledger (source: lib/gate-ledger.js) ---
// AUTO-GENERATED — DO NOT EDIT BY HAND.
// Source: plugin-task-loop/workflows/lib/gate-ledger.js
// Regenerate: ./scripts/sync-workflow-inline.sh
...
function buildDevPrompt(assignment, currentRound, maxRound, reworkSource) {
  ...
  return [
    ...
    RESOLVED_BUDGETS ? `\n${buildBudgetSection('developer', RESOLVED_BUDGETS.developer)}` : '',
  ]
    .filter(Boolean)
    .join('\n');
}
...
function buildTestStagePrompt(currentRound, maxRound, reworkSource, reworkedDevIndices) {
  ...
  const parts = [
    ...
    RESOLVED_BUDGETS ? `\n${buildBudgetSection('integration-tester', RESOLVED_BUDGETS['integration-tester'])}` : '',
    ``,
...
function buildReviewPrompt(opts) {
  ...
  const parts = [
    ...
    RESOLVED_BUDGETS ? `\n${buildBudgetSection('reviewer', RESOLVED_BUDGETS.reviewer)}` : '',
  ];
...
while (mainRound < EFFECTIVE_MAX_ROUNDS && !sessionPassed) {
  ...
  if (HAS_TEST_STAGE) {
    ...
    gateLedger.record({
      ...
      verdict: normalizeIntegrationVerdict(integrationResult),
      devsToLaunch,
      agentSeq: stageTelemetry.length - 1,
      elapsed_ms: stageTelemetry[stageTelemetry.length - 1]?.elapsed_ms,
    });
...
return {
  ...
  gate_ledger: gateLedger.entries(),
  gate_stats: gateLedger.stats(),
  observer_log_path: typeof process !== 'undefined' && process.env
